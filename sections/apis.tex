...
\begin{figure}[h]
    \centering
    \fbox{\parbox[c][5cm][c]{0.82\textwidth}{\centering\textbf{Platzhalter für Frontend-Screenshot}\\Film-Detailansicht mit Anzeige der verfügbaren Streaming-Anbieter\\Hier später Screenshot der Provider-Darstellung einfügen.}}
    \caption{Platzhalter für einen Screenshot der Anbieteranzeige im Frontend}
