...
\begin{figure}[H]
    ...
    \caption{Eingabemaske zur Erfassung und Speicherung eines Abonnements}
...
\begin{figure}[H]
    ...
    \caption{Abo-Verwaltung mit Filter- und Bearbeitungsfunktionen}
...
\begin{figure}[H]
    ...
    \caption{Oberer Bereich der Film-Detailansicht mit Poster, Metadaten und Beschreibung}
...
\begin{figure}[H]
    ...
    \caption{Unterer Bereich der Film-Detailansicht mit \glqq Passende Abos\grqq{} und allgemeiner Anbieterübersicht}
...
\begin{figure}[H]
    ...
    \caption{Geschützter Bereich der Abo-Verwaltung nach erfolgreicher Anmeldung über Keycloak}
